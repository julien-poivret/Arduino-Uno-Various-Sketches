/*
       ...
       ( in a practical a use, an AnalogRead may do the trick most of the time )
       -> but better to understand hardware in order to track it's technological 
       evolution and features advantage,
       when it will be time to work one a more advanced chip. 
*/
